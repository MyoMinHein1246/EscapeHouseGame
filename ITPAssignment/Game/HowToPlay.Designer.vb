...
Partial Class HowToPlayForm
	...
	Private Sub InitializeComponent()
		...
		Dim ListViewItem8 As ListViewItem = New ListViewItem(New String() {"Images", "created using 'Bing Image Create'", "https://www.bing.com/create"}, -1)
		Dim ListViewItem9 As ListViewItem = New ListViewItem(New String() {"Art Room Image", "magnificent view of authentic classic house's exquisite art gallery, digital art"}, -1)
		Dim ListViewItem10 As ListViewItem = New ListViewItem(New String() {"Bathroom 1 Image", "magnificent view of authentic classic house's bathroom with toilet, no doors, digital art"}, -1)
		Dim ListViewItem11 As ListViewItem = New ListViewItem(New String() {"Bathroom 2 Image", "magnificent view of authentic classic house's bathroom with basins, and 1 door way, digital art"}, -1)
		Dim ListViewItem12 As ListViewItem = New ListViewItem(New String() {"Bedroom 1 Image", "magnificent view of authentic classic house's spotless, luxurious bedroom with 1 door, digital art"}, -1)
		Dim ListViewItem13 As ListViewItem = New ListViewItem(New String() {"Computer Room Image", "magnificent view of authentic classic house's room with computers 1 door, digital art"}, -1)
		Dim ListViewItem14 As ListViewItem = New ListViewItem(New String() {"Exit Room Image", "magnificent view of authentic classic house, digital art"}, -1)
		Dim ListViewItem15 As ListViewItem = New ListViewItem(New String() {"Hall Image", "magnificent view of authentic classic house's big hall with 3 doors, digital art"}, -1)
		Dim ListViewItem16 As ListViewItem = New ListViewItem(New String() {"Kitchen Image", "magnificent view of authentic classic house's spotless kitchen with 2 door way, digital art"}, -1)
		Dim ListViewItem17 As ListViewItem = New ListViewItem(New String() {"Living Room Image", "magnificent view of authentic classic house's big living room with 6 doors, digital art"}, -1)
		Dim ListViewItem18 As ListViewItem = New ListViewItem(New String() {"Store Room Image", "magnificent view of authentic classic house's store room with full of stuff, digital art"}, -1)
		Label1 = New Label()
		Label2 = New Label()
		btnClose = New Button()
		...
		ListView2.Items.AddRange(New ListViewItem() {ListViewItem7, ListViewItem8, ListViewItem9, ListViewItem10, ListViewItem11, ListViewItem12, ListViewItem13, ListViewItem14, ListViewItem15, ListViewItem16, ListViewItem17, ListViewItem18})
